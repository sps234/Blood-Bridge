...
<body style="background-color: #f5f5dc;">
    ...
    <a class="navbar-brand" href="../index.php" style="color: var(--text-color);font-size:22px;letter-spacing:2px;">Blood Bridge</a>
        ...
        function blood_group(int $name,string $val)
        {
            ...
            '
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    ...
                    <img id="animated-image" src="../Assets/images/blood-drop.svg" alt="">
