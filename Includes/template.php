<?php
    ...
    {
        $imagePath = ($name[0] === 'Donor') ? '../Assets/images/donor.jpg' : '../Assets/images/rec.jpg';
        echo 
        '
            <style>
                .transparent-bg {
            ...
            <div class="container mt-5">
                ...
                <div class="row align-items-center mt-4">
                    <div class="col-lg-6 mb-4">
                        <img src='.$imagePath.' class="img-fluid d-none d-lg-block" style="width: 380px; height: 350px;">
                    </div>
                    <div class="col-lg-6">
                        <div class="row">
